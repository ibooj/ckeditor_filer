(function (jQuery) {
    CKEDITOR.plugins.add('filerimage', {
        ...
        init: function (editor) {
            ...
            jQuery.get('/ckeditor_filer/filer_version/', {}, function (data) {
            ...
            jQuery.get('/ckeditor_filer/setting/use_thumbnailoptions_only/', {}, function (data) {
                editor.use_thumbnailoptions_only = data
            });
            jQuery.get('/ckeditor_filer/setting/use_canonical_for_thumbnails/', {}, function (data) {
                if (data == '0') {
            ...
            jQuery.get('/ckeditor_filer/url_reverse/',
